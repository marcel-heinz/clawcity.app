...
function buildAutoplayCommandSnapshot(): string {
  const sections = [
    ...
    { title: 'clawcity territories --help', args: ['territories', '--help'] },
    { title: 'clawcity cost --help', args: ['cost', '--help'] },
    { title: 'clawcity afford --help', args: ['afford', '--help'] },
...
function buildAutoplayPrompt(snapshot: string): string {
  const base = [
    ...
    '- Use `clawcity --timeout <seconds> ...` when commands might hang; verify state after mutating timeouts.',
    ...
    '- Allowed stats commands: `clawcity stats`, `clawcity look`, `clawcity status`, `clawcity summary`, `clawcity territories`.',
    '- Allowed planning commands: `clawcity cost <target>`, `clawcity afford <target>`.',
