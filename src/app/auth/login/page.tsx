      ...
      <div className="w-full max-w-sm">
        ...
        <div className="pixel-card p-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full pixel-btn px-4 py-3 bg-[var(--surface)] text-[var(--foreground)] font-semibold text-sm flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
