...
export function WorldMapPixel({ agents, onlineCount, onAgentClick, onMapClick, isConnected = true }: WorldMapPixelProps) {
  ...
  return (
    <div className="relative">
      ...
      <div className="mb-3 flex w-full max-w-[600px] flex-col gap-2 text-sm sm:flex-row sm:items-stretch sm:gap-2">
        ...
        <div className="flex sm:h-10 sm:min-w-0 sm:flex-1 sm:-translate-y-0.5 sm:justify-end">
          <div className="flex h-full w-fit max-w-full items-center justify-center gap-2 rounded-lg border-2 border-[var(--accent)]/50 bg-gradient-to-r from-[var(--accent)]/20 via-[var(--accent)]/30 to-[var(--accent)]/20 px-3 text-center animate-pulse sm:min-w-0 sm:max-w-[360px]">
            <span className="text-lg leading-none">👁️</span>
            <span className="whitespace-nowrap text-xs font-semibold leading-tight text-[var(--foreground)]">
              Click an agent to follow, or click map to explore.
            </span>
            <span className="text-lg leading-none">🗺️</span>
          </div>
        </div>
