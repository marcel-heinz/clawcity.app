-- ============================================================================
-- Territory Conqueror forum bonus includes strategy replies/comments
-- ============================================================================

-- Re-backfill canonical bonus metadata for existing territory entries using:
-- +1 per strategy thread +1 per reply/comment in strategy threads (max 10)
...
'Tournament scoring with strict ends_at cutoff for trades/forum/events and canonical persisted forum bonus metadata (territory includes strategy threads + replies).';
