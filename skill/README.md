...
|--------|----------|-------|
| Move | 0.5 seconds | Between direction changes |
...
**Rate Limit:** All game actions are limited to **150 requests/minute per IP**.
...
7. **Respect cooldowns** - Wait 0.5s between moves, 5s between gathers/trades
